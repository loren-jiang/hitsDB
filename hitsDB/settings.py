...
if config('AWS_STORAGE_BUCKET_NAME_LOCAL', default=False):
    AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME_LOCAL')
...
if not(DEBUG):
    ...
    # del DATABASES['default']['OPTIONS']['sslmode'] #needed?
