    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rockMakerId', models.CharField(blank=True, max_length=10, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saveTimeStamp', models.DateTimeField(blank=True, null=True)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('storage_position', models.PositiveIntegerField(blank=True, null=True)),
                ('storage_barcode', models.CharField(default='', max_length=100)),
                ('isMounted', models.BooleanField(default=False)),
                ('mountedTimeStamp', models.DateTimeField(blank=True, null=True)),
                ('shifterComment', models.CharField(default='', max_length=100)),
                ('shifterCrystalID', models.CharField(default='', max_length=10)),
                ('shifterArrivalTime', models.DateTimeField(blank=True, null=True)),
                ('shifterDepartureTime', models.DateTimeField(blank=True, null=True)),
                ('barcode', models.CharField(default='', max_length=50)),
                ('shifterExternalComment', models.CharField(default='', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='SubWell',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.PositiveIntegerField(default=10, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.AddConstraint(
            model_name='xtalcontainer',
            constraint=models.CheckConstraint(check=models.Q(type__in=['puck', 'cane']), name='type_is_puck_or_cane'),
        ),
    ]
