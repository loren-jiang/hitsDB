    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compounds', models.ManyToManyField(blank=True, null=True, related_name='subwells', to='experiment.Compound')),
            ],
            options={
                'ordering': ('idx',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crystal_screen', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wells', to='experiment.CrystalScreen')),
