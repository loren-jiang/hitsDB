    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('init_data_file', models.FileField(blank=True, null=True, storage=s3.s3utils.PrivateMediaStorage(), upload_to=experiment.models.exp_init_upload_path)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('drop_x', models.DecimalField(decimal_places=2, default=0, max_digits=6)),
                ('drop_y', models.DecimalField(decimal_places=2, default=0, max_digits=6)),
                ('drop_radius', models.DecimalField(decimal_places=2, default=0, max_digits=6)),
                ('well_x', models.DecimalField(decimal_places=2, default=0, max_digits=6)),
                ('well_y', models.DecimalField(decimal_places=2, default=0, max_digits=6)),
                ('well_radius', models.DecimalField(decimal_places=2, default=0, max_digits=6)),
