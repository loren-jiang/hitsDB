    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zinc_id', models.CharField(blank=True, max_length=30, null=True)),
        ...
        migrations.AddField(
            model_name='compound',
            name='library',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='compounds', to='import_ZINC.Library'),
        ),
    ]
