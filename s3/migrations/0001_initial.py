    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload', models.FileField(blank=True, null=True, storage=s3.s3utils.PublicMediaStorage(), upload_to=s3.models.user_folder_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_fileName', models.CharField(default='', max_length=100)),
                ('key', models.UUIDField(default=uuid.uuid4, unique=True)),
                ('upload', models.FileField(storage=s3.s3utils.PrivateMediaStorage(), upload_to=s3.models.user_folder_upload_path, validators=[django.core.validators.FileExtensionValidator(['json'])])),
                ('local_upload', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='media/'), upload_to=s3.models.user_folder_upload_path, validators=[django.core.validators.FileExtensionValidator(['json'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_fileName', models.CharField(default='', max_length=100)),
                ('key', models.UUIDField(default=uuid.uuid4, unique=True)),
                ('upload', models.FileField(storage=s3.s3utils.PrivateMediaStorage(), upload_to=s3.models.user_folder_upload_path)),
